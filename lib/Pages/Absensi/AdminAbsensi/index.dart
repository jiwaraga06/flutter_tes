...
class AdminAbsensi extends StatefulWidget {
  AdminAbsensi({Key? key}) : super(key: key);

  @override
  State<AdminAbsensi> createState() => _AdminAbsensiState();
}
...
void getAbsenPegawai() async {
    ...
    try {
      var url = Uri.parse(API_ABSENSI.dataAdmin(tgl_awal, tgl_akhir));
      var response =
